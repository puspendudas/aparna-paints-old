										...
										<div class="d-flex align-items-center justify-content-between flex-wrap p-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
											<div class="d-flex align-items-center mr-2">
												...
												<div class="symbol bg-white-o-15 mr-3">
													<span class="symbol-label text-success font-weight-bold font-size-h4">FT</span>
												</div>

												<!--end::Symbol-->

												<!--begin::Text-->
												<div class="text-white m-0 flex-grow-1 mr-3 font-size-h5">FinTrack</div>
										...
										<div class="navi navi-spacer-x-0 pt-5">
											...
											<!-- <a href="javascript:;" class="navi-item px-8">
												<div class="navi-link">
													...
													<div class="navi-text">
														<div class="font-weight-bold">My Setting</div>
														<div class="text-muted">System settings and more
															<span class="label label-light-danger label-inline font-weight-bold">Submited</span>
														</div>
													</div>
												</div>
											</a> -->
											...
											<div class="navi-footer px-8 py-5">
												<a href="lib/logout.php" class="btn btn-light-primary font-weight-bold">Sign Out</a>
